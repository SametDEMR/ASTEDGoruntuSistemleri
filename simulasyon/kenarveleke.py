...
def distort_and_add_stains(image_path, scale_percent=100, size=15, num_points_each_side=1, rotation_angle=0,
                           num_stains=5, num_particles=20):
    # --- 1) Inward Distortion ---
    ...
    # --- 2) Lekeler ve partiküller ekle ---
    # OpenCV BGR -> PIL RGBA
    img_pil = Image.fromarray(cv2.cvtColor(distorted_image, cv2.COLOR_BGR2RGBA))
